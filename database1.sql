...
-- Sub-criteria C2: Pengalaman (Skala 0-100)
INSERT INTO sub_criteria (criteria_id, label, value) VALUES
((SELECT id FROM criteria WHERE code='C2'), '>3 Tahun', 100.00),
((SELECT id FROM criteria WHERE code='C2'), '3 Tahun', 75.00),
((SELECT id FROM criteria WHERE code='C2'), '2 Tahun', 50.00),
((SELECT id FROM criteria WHERE code='C2'), '1 Tahun', 25.00),
((SELECT id FROM criteria WHERE code='C2'), 'Tidak Ada Pengalaman', 0.00);

-- Sub-criteria C3: Pre-Test (Bobot diskrit berdasarkan range nilai)
INSERT INTO sub_criteria (criteria_id, label, value) VALUES
...
-- Sub-criteria C4: Pendidikan (Skala 0-100)
INSERT INTO sub_criteria (criteria_id, label, value) VALUES
((SELECT id FROM criteria WHERE code='C4'), 'D3/S1/S2', 100.00),
((SELECT id FROM criteria WHERE code='C4'), 'SMA/SMK', 50.00),
((SELECT id FROM criteria WHERE code='C4'), 'SMP', 0.00);

-- Sub-criteria C5: Umur (Skala 0-100)
INSERT INTO sub_criteria (criteria_id, label, value) VALUES
((SELECT id FROM criteria WHERE code='C5'), '24-25 Tahun', 100.00),
((SELECT id FROM criteria WHERE code='C5'), '22-23 Tahun', 75.00),
((SELECT id FROM criteria WHERE code='C5'), '20-21 Tahun', 50.00),
((SELECT id FROM criteria WHERE code='C5'), '18-19 Tahun', 25.00);
